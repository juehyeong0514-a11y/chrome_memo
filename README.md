...
- 팝업의 도구막대 크기 슬라이더는 현재 탭에 즉시 미리보기로 반영하고, 최종 값은 짧은 debounce 후 저장합니다.

## 도구

- 펜: 볼펜, 만년필, 붓펜
- 형광펜: 현재 색상과 형광펜 투명도/폭 배율을 사용합니다.
...
- 확장 프로그램 ON/OFF
- 도구막대 크기 슬라이더 조절: 움직이는 중 현재 탭 도구막대에 실시간 미리보기를 적용합니다.
- 현재 페이지 전체 지우기
- 도구막대 위치 초기화
- 현재 페이지 지원 여부 확인
